...
$metabox=themesgenerator_metabox_get_meta( 'custom_metabox_show_titlepost' );
if (!empty($metabox)) {
...
$metabox2=themesgenerator_metabox_get_meta( 'custom_metabox_show_metapost');
if (!empty($metabox2)) {
		...
		<main id="main" class="site-main" role="main">
			...
			while ( have_posts() ) : the_post();
				...
				the_post_navigation( array(
					'prev_text' => '<span class="screen-reader-text">' . __( 'Previous Post', 'themesgenerator' ) . '</span><span aria-hidden="true" class="nav-subtitle">' . __( 'Previous', 'themesgenerator' ) . '</span> <span class="nav-title"><span class="nav-title-icon-wrapper">' . themesgenerator_get_svg( array( 'icon' => 'arrow-left' ) ) . '</span>%title</span>',
					'next_text' => '<span class="screen-reader-text">' . __( 'Next Post', 'themesgenerator' ) . '</span><span aria-hidden="true" class="nav-subtitle">' . __( 'Next', 'themesgenerator' ) . '</span> <span class="nav-title">%title<span class="nav-title-icon-wrapper">' . themesgenerator_get_svg( array( 'icon' => 'arrow-right' ) ) . '</span></span>',
				) );
